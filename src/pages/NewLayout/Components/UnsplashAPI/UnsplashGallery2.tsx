...
function UnsplashGallery2 ({ data }: { data: ImageData }) {
    ...
    return(
        <ImageContext.Provider value={value}>
            <Container>
                {isLoading ? <ReactLoading type={'spin'} color={'#eee'} height={200} width={100}/> : response.length > 0 && <Image data={response[4]} />}
            </Container>
...
export default UnsplashGallery2;
