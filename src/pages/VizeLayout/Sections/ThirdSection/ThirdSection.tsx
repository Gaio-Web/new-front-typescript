      ...
      <div id='thirdSection'className={'third-wrapper'}>
        ...
        <div className="difCards" style={{backgroundColor: mainColor}}>
          <svg viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M17.42 32.8464C25.9397 32.8464 32.8464 25.9397 32.8464 17.42C32.8464 8.90018 25.9397 1.99353 17.42 1.99353C8.90018 1.99353 1.99353 8.90018 1.99353 17.42C1.99353 25.9397 8.90018 32.8464 17.42 32.8464Z" stroke={secondaryColor} stroke-width="0.481798" stroke-miterlimit="10"/>
          </svg>
        ...
        <div className="difCards" style={{backgroundColor: mainColor}}>
          <svg viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M17.42 32.8464C25.9397 32.8464 32.8464 25.9397 32.8464 17.42C32.8464 8.90018 25.9397 1.99353 17.42 1.99353C8.90018 1.99353 1.99353 8.90018 1.99353 17.42C1.99353 25.9397 8.90018 32.8464 17.42 32.8464Z" stroke={secondaryColor} stroke-width="0.768583" stroke-miterlimit="10"/>
          </svg>
        ...
        <div className="difCards" style={{backgroundColor: mainColor}}>
          <svg viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M17.42 32.8464C25.9397 32.8464 32.8464 25.9397 32.8464 17.42C32.8464 8.90018 25.9397 1.99353 17.42 1.99353C8.90018 1.99353 1.99353 8.90018 1.99353 17.42C1.99353 25.9397 8.90018 32.8464 17.42 32.8464Z" stroke={secondaryColor} stroke-width="0.573569" stroke-miterlimit="10"/>
          </svg>
