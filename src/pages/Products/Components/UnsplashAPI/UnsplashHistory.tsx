...
function UnsplasHistoryImage({ data }: { data: ImageData }): JSX.Element {
    ...
    <ImageContext.Provider value={value}>
      <Container>
        {isLoading ? (
          ...
          <>
            <img ref={imgRef} src={response[2].urls.small} alt={data.alt_description} onLoad={handleImageLoad} />
            <Overlay className="unsplashImgOverlay" ref={overlayRef}>
              <OverlayText className="overlayText">
                <h3>Imagem relacionada a história</h3>
                <h5 className="overlaySubtitle">Alguém trabalhando, foto dos fundadores...</h5>
              </OverlayText>
            </Overlay>
          </>
        ): null}
...
export default UnsplasHistoryImage;
