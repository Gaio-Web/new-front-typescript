...
function UnsplasHistoryImage ({ data }: { data: ImageData }) {
  ...
  const { response, isLoading, error, fetchData } = useAxios(`search/photos?page=1&orientation=landscape&query=${data.coverKeyWords}&client_id=gz6269fjUdh2U2Ne7qlX0jBilMNMnCPSGToMMVGuH0o`);
