...
function ThirdSection({isAutonomous, quality1, qualitydescription1, quality2, qualitydescription2, quality3, qualitydescription3, color, onClick}: IThirdSectionProp): JSX.Element{
  return (
    <Container>
